...
const CEs = [
  "./C.E/Cadavre-Exquis2.jpg",
  "./C.E/Cadavre-Exquis3.jpg",
  "./C.E/Cadavre-Exquis4.jpg",
  "./C.E/Cadavre-Exquis5.jpg",
];
      ...
      Cadavre Exquis
        ...
        <div id="images-description">
          <div id="images">
            ${CEs
              .map(
                (Cadavre-Exquis, index) => `<img src="${Cadavre-Exquis}" alt="Cadavre-Exquis${index + 1}" />`
              )
              .join("")}
          </div>
